local general = {
	...
	normal_mode = {
		...
		{ keys = '<C-`>', command = '<Cmd>FzfLua buffers<CR>', desc = 'Find in buffers' },
		...
		{ keys = '<leader>ai', command = ':Refactor inline_var ', desc = 'Inline variable' },
		{ keys = '<leader>aI', command = ':Refactor inline_func', desc = 'Inline function' },
		{ keys = '<leader>ab', command = ':Refactor extract_block', desc = 'Extract block' },
		{ keys = '<leader>aB', command = ':Refactor extract_block_to_file', desc = 'Extract block to file' },
	},
	visual_mode = {
	...
	visual_block_mode = {
		{ keys = '<leader>ae', command = ':Refactor extract ', desc = 'Extract function' },
		{ keys = '<leader>af', command = ':Refactor extract_to_file ', desc = 'Extract function to file' },
		{ keys = '<leader>av', command = ':Refactor extract_var ', desc = 'Extract variable' },
		{ keys = '<leader>ai', command = ':Refactor inline_var ', desc = 'Inline variable' },
	},
	term_mode = {
...
local which_key = {
	...
	{ '<leader>/', '<Cmd>lua _BTOP_TOGGLE()<CR>', desc = 'Resouce monitor', nowait = true, remap = false },
	...
	{ '<leader>gh', group = 'GitHub', nowait = true, remap = false },
	{
		'<leader>ghi',
	...
	},
	{
		...
		desc = 'List PRs (all states)',
		nowait = true,
		remap = false,
	},
	{
		'<leader>ghd',
		'<Cmd>lua vim.ui.input({ prompt = "PR #: " }, function(n) if n and n ~= "" then Snacks.picker.gh_diff({ pr = tonumber(n) }) end end)<CR>',
		desc = 'View PR diff',
		nowait = true,
		remap = false,
	},
	...
	{ '<leader>gv', '<Cmd>DiffviewOpen<CR>', desc = 'Open diffview', nowait = true, remap = false },
	{
		...
		desc = 'Browse current file at remote',
		nowait = true,
		remap = false,
	},
	{
		'<leader>gy',
		'<Cmd>lua Snacks.gitbrowse({ open = function(url) vim.fn.setreg("+", url); vim.notify("Copied: " .. url) end, notify = false })<CR>',
		desc = 'Copy git link',
		nowait = true,
		remap = false,
	},
...
local lsp = {
	...
	{ '[d', '<Cmd>lua vim.diagnostic.jump({ count = -1, float = true })<CR>', desc = 'Previous diagnostic', remap = false },
	{ ']d', '<Cmd>lua vim.diagnostic.jump({ count = 1, float = true })<CR>', desc = 'Next diagnostic', remap = false },
